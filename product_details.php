...
if (isset($_POST['good'])) {
    if (!isset($_SESSION['usur_id'])) {
        ...
        $query = "INSERT into card(
            buy_usur_id,quantity,author_id,p_id,p_name,p_des,p_price,p_image,c_date) 
            values ('$u_id','$quantity','$author_id','$p_id','$p_name','$p_des','$p_price','$p_image','$c_date')";
...
if (isset($_POST['add_now'])) {
    if (!isset($_SESSION['usur_id'])) {
        ...
        $p_price = $new_product_select['p_price'];
        $p_image = $new_product_select['p_img'];
        $c_date = $new_product_select['c_date'];
        $query = "INSERT into card(
            buy_usur_id,u_id,quantity,author_id,p_id,p_name,p_des,p_price,p_image,c_date) 
            values ('$u_id','$u_id','$quantity','$author_id','$p_id','$p_name','$p_des','$p_price','$p_image','$c_date')";
