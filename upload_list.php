            ...
            <div class="col-md-12">
              ...
              if($db->delete($delete_query)){?>
               <div class="alert alert-success">
                <strong>Success!</strong>Votre produit a été supprimé!.
              </div>  
            <?php  }
              }
                ?>
              ...
              <div class="panel-heading"><h2>produits Ajoutés</h2></div>
              <div class="panel-body">
                <table class="table table-striped table-bordered">
                  <tr class="">
                    <th style="padding: 15px">Si.</th>
                    <th style="padding: 15px">Categorie</th>
                  ...
                  <tr>
                    ...
                    <td style="padding: 15px"><?php echo $result_painding['p_price']?>DH</td>
                    <td style="padding: 15px"><a href="edit_product.php?edit_id=<?php echo $result_painding['p_id'] ?>" class="">Modifier </a>||<a href="?remove_id=<?php echo $result_painding['p_id'] ?>"> Supprimer</a></td>
                  </tr>
                <?php }}?>
                </table>
              </div>
